    ...
    public class EmailService
    {
        ...
        public async Task SendPasswordResetEmailAsync(string recipientEmail, string resetToken)
        {
                ...
                <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>
                    ...
                    <div style='background-color: #f8f9fa; padding: 20px; border-radius: 5px; margin: 20px 0;'>
                        ...
                        <p style='text-align: center; margin: 25px 0;'>
                            <a href='http://localhost:5500/reset-password/reset-password.html?token={encodedToken}&email={encodedEmail}' 
            ...
            bodyBuilder.TextBody = $@"
                ...
                http://localhost:5500/reset-password/reset-password.html?token={encodedToken}&email={encodedEmail}
